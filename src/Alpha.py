...
# --- STEP 4: Discover Petri net using Alpha Miner ---
net, initial_marking, final_marking = alpha_miner.apply(log)

# --- STEP 5: Save Petri net visualization ---
pn_gviz = pn_visualizer.apply(net, initial_marking, final_marking)
pn_visualizer.save(pn_gviz, "Output/petri_net_alpha.png")
print("✅ Petri net (Alpha Miner) saved as 'petri_net_alpha.png'")
...
if not dfg_perf:
    print("⚠️ Performance DFG was empty — falling back to frequency DFG.")
    ...
    print("✅ Performance DFG saved as 'dfg_performance_alpha.png'")
